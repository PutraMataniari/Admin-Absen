...
>
    ...
    >
        ...
        <a href="{{ url('/admin') }}" class="flex items-center gap-2 font-bold text-lg">
            <img src="{{ asset('images/logo_kpu1.png') }}" alt="Logo" class="h-10">
            <span class="text-black dark:text-white">SIAGA</span>
        </a>
